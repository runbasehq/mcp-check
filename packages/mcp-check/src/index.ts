...
export type { ModelName, Models } from "./ai";
 ...
 * @example
 * ```typescript
 * const client = client(mcpServer, ["claude-3-haiku-20240307", "gpt-5"], {
 *   silent: true,
...
export function createClient<T extends ModelName>(
  mcpServer: McpServer,
  models: T[],
